        ...
        <dl className="flex flex-col space-y-8">
          <EventInformation name="Que dia?">
            <>
              ...
              <a
                className="nowrap relative top-[-2px] ml-4 select-none whitespace-nowrap rounded-full border border-joanGreen-500 py-[0.25rem] px-[0.75rem] align-middle font-sans text-sm hover:bg-joanGreen-500 hover:text-white"
