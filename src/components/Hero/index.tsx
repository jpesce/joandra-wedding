      ...
      <div className="absolute bottom-16 left-12">
        ...
        <div className="space-x-4">
          <a
            ...
            className="inline-flex min-h-[2.5rem] select-none items-center rounded-full border border-white px-5 text-white transition hover:bg-white hover:text-joanGreen-600"
          >
            Escolher presente
          </a>
          <a
